...
<body class="page-elements">
	...
	<div id="content">
		<div class="container" style='min-height:500px;'>
					...
					<h2>Obfuscate the User files</h2>
<hr/>			
				...
				<div class='row'>
					...
					<br/>
							...
							%>
								...
								<br/><br/>
								<a href='obf.jsp'>Go Back</a>
							<%
								}  else {
							%>
   							<br/>    

							<form action='obf' id='frm'>
								<input type=hidden name='type' value='obf' />
								<input type="submit" value='Start Obfuscation' class='btn btn-warning form-control' id='btn'/>							
							</form>
