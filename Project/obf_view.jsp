					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav" id="main-menu">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown"><%=u1.getFname()%> <%=u1.getLname()%><b
									class="caret"></b></a> <!-- Dropdown Menu -->
								<ul class="dropdown-menu">
									<li class="dropdown-header">Profile Actions</li>
									<li><a href="updateprofile.jsp" tabindex="-1"
										class="menu-item">Edit Profile</a></li>
									<li><a href="changepassword.jsp" tabindex="-1"
										class="menu-item">Change Password</a></li>
									<li><a href="account?request_type=deleteprofile"
										tabindex="-1" class="menu-item">Delete Profile</a></li>
									<li><a href="account?request_type=logout" tabindex="-1"
										class="menu-item">Logout</a></li>
								</ul></li>
		...
		<div class="container" style='min-height: 500px;'>
			...
			<div class='row'>
				<div class='col-md-8'>
											...
											for (String f : files) {
												%>
													<tr>
														...
														<td> <a href='downloadobf?file=<%=f%>'><i class="fa fa-download"></i> Download</a></td>
													</tr>
												<%
											}
										%>									
					...
					%>
					<h4>No Obfuscated files available at this moment</h4>
					<%
						}
					%>
